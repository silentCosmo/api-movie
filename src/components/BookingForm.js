    ...
    <div className="flex items-center justify-center h-screen mt-3 fixed inset-0 bg-black bg-opacity-50">
      <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
        <h1
          ...
          className="text-end text-sm mt-[-1rem] cursor-pointer"
        >
          x
        </h1>
        <h2 className="text-2xl text-red-950 text-center font-semibold mb-4">
        ...
        <form>
          <div className="mb-4">
            ...
            <input
              type="text"
              className="w-full p-2 border rounded-md text-red-700 font-extrabold tracking-wider text-center"
              value={movie.name}
            />
          </div>
          <div className="mb-4">
